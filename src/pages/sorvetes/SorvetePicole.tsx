...
import {
  SorveteProps,
  SorveteServicePicole,
} from '../../shared/services/api/sorvete/SorveteServicePicole';
import { ListaSorvetes } from './ListaSorvetes';

export const SorvetePicole: React.FC = () => {
  ...
  useEffect(() => {
    debounce(() => {
      SorveteServicePicole.getAll(pagina, busca).then((result) => {
