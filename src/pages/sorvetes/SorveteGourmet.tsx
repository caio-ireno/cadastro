...
import {
  SorveteProps,
  SorveteServiceGourmet,
} from '../../shared/services/api/sorvete/SorveteServiceGourmet';
import { ListaSorvetes } from './ListaSorvetes';

export const SorveteGourmet: React.FC = () => {
  ...
  useEffect(() => {
    debounce(() => {
      SorveteServiceGourmet.getAll(pagina, busca).then((result) => {
