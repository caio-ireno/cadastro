...
import {
  SorveteProps,
  SorveteServiceStandart,
} from '../../shared/services/api/sorvete/SorveteServiceStandart';

import { ListaSorvetes } from './ListaSorvetes';

export const SorveteStandart: React.FC = () => {
  ...
  useEffect(() => {
    debounce(() => {
      SorveteServiceStandart.getAll(pagina, busca).then((result) => {
